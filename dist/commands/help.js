...
export const handleHelpCommand = (message) => {
    const embed = new EmbedBuilder()
        ...
        .addFields({ name: '!status <TICKER>', value: 'Get token info for a specific ticker on Mainnet.' }, { name: '!balance <WALLET_ADDRESS>', value: 'Check KRC20 token balances for a wallet on Mainnet.' }, { name: '!links', value: 'Get official Nacho the 𐤊at community links.' }, { name: '!donate', value: 'View donation information for the Nacho the 𐤊at Community.' }, { name: '!helpmenu', value: 'Display this help menu.' })
        .setFooter({
